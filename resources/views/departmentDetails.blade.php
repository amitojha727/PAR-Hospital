		...
		<div class="row">
			<div class="col-md-12">
				<div class="block text-center">
					...
					<h1 class="text-capitalize mb-5 text-lg">{{ $department->site_nm }}</h1>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="department-img">
					<img src="{{ asset('website/images/service/bg-1.jpg') }}" alt="" class="img-fluid">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					...
					<a href="{{ route('appoinment') }}" class="btn btn-main-2 btn-round-full">Make an Appoinment<i
