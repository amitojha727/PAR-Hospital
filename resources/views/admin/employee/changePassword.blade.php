...
@section('sub-header')
	<div class="col-sm-6">
		<h1 class="m-0">{{ $employee_details->emp_fname }} {{ $employee_details->emp_sname }}</h1>
	</div><!-- /.col -->
	<div class="col-sm-6">
				...
				<td width="70%">
					<div class="col-lg-12">
					  <div class="card">
						...
						<div class="card-body">
						  <form method="POST" action="{{ route('admin.employee.changePasswordStore') }}">
							@csrf
						    <input type="hidden" name="emp_id" value="{{ $employee_details->emp_id }}"/>
