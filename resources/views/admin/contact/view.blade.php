					...
					<table id="example" class="display nowrap" style="width:100%">
						...
						<tbody id="tb2">
							...
							<tr style="border-bottom:1px solid #F7F7F7;">
                                ...
                                <td style="padding:0px 10px;">{{ $row->email_address }}</td>
                                <td style="padding:10px 10px;">{{ $row->contact_number }}</td>
                                <td style="padding:10px 10px;">{{ $row->query_topic }}</td>
